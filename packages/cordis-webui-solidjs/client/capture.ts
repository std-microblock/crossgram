...
import type { MtprotoCaptureSnapshot } from '../../mtproto-debug/src/capture-api.js'
import { readResponse } from './pages/admin-model.js'
import { sameOriginPath } from './pages/bridge-model.js'
